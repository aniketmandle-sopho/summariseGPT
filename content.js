/******/ (() => {
      ...
      Readability.prototype = {
        ...
        _prepDocument: function () {
          ...
          this._replaceNodeTags(
            this._getAllNodesWithTag(doc, ["font"]),
            "SPAN"
          );
        },
        ...
        _textSimilarity: function (textA, textB) {
          ...
          var distanceB =
            uniqTokensB.join(" ").length / tokensB.join(" ").length;
          return 1 - distanceB;
        },
        ...
        _grabArticle: function (page) {
          ...
          while (true) {
            ...
            if (topCandidate === null || topCandidate.tagName === "BODY") {
              ...
              if (
                alternativeCandidateAncestors.length >= MINIMUM_TOPCANDIDATES
              ) {
              ...
              if (this._getCharCount(node, ",") < 10) {
                ...
                for (var i = 0; i < embeds.length; i++) {
                  ...
                  for (var j = 0; j < embeds[i].attributes.length; j++) {
                    if (
                      this.REGEXPS.videos.test(embeds[i].attributes[j].value)
                    ) {
                      return false;
                    }
                  }
  ...
  (() => {
    "use strict";
    /* harmony import */ var _mozilla_readability__WEBPACK_IMPORTED_MODULE_0__ =
      __webpack_require__(107);
    /* harmony import */ var _mozilla_readability__WEBPACK_IMPORTED_MODULE_0___default =
      /*#__PURE__*/ __webpack_require__.n(
        _mozilla_readability__WEBPACK_IMPORTED_MODULE_0__
      );
    /* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_1__ =
      __webpack_require__(755);
    /* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_1___default =
      /*#__PURE__*/ __webpack_require__.n(jquery__WEBPACK_IMPORTED_MODULE_1__);

    const SHADOW_ROOT_ID = "readergpt__shadowRoot";
    var article =
      new _mozilla_readability__WEBPACK_IMPORTED_MODULE_0__.Readability(
        document.cloneNode(true)
      ).parse();
    async function fetchPromptAndTriggerSummary() {
      const prompt = await chrome.runtime.sendMessage({
        type: "GET_DEFAULT_PROMPT",
      });
      triggerSummaryWithPrompt(prompt.value);
    }
    async function triggerSummaryWithPrompt(prompt) {
      logEvent("summary_triggered");
      await appendContentCard();
      if (!!article && !!article.textContent) {
        logEvent("readable_text_found");
        console.log("Parsed the article");
        createBridge(article.textContent, prompt);
      } else {
    ...
    function closePopup() {
      ...
      (_a = popup === null || popup === void 0 ? void 0 : popup.parentNode) ===
        null || _a === void 0
        ? void 0
        : _a.removeChild(popup);
    }
    ...
    async function appendContentCard() {
      ...
      const crossUrl = chrome.runtime.getURL("images/cross.png");
      const gptUrl = chrome.runtime.getURL("images/icon32.png");
      const optionsPage = chrome.runtime.getURL("options.html");
      const popupPageUrl = chrome.runtime.getURL("popup.html");
      const copyUrl = chrome.runtime.getURL("images/copy.png");
      ...
      (_a = sRoot.shadowRoot) === null || _a === void 0
        ? void 0
        : _a.appendChild(container);

      (_b = document.getElementsByTagName("body")[0]) === null || _b === void 0
        ? void 0
        : _b.append(sRoot);
      ...
      setTimeout(() => {
        ...
        (_g = elementById("readergpt__crossBtnImg")) === null || _g === void 0
          ? void 0
          : _g.setAttribute("src", crossUrl);

        (_a = elementById("readergpt__mainIcon")) === null || _a === void 0
          ? void 0
          : _a.setAttribute("src", gptUrl);

        (_b = elementById("readergpt__copyButtonImage")) === null ||
        _b === void 0
          ? void 0
          : _b.setAttribute("src", copyUrl);

        (_c = elementById("readergpt__addPromptButton")) === null ||
        _c === void 0
          ? void 0
          : _c.setAttribute("href", optionsPage);

        (_d = elementById("readergpt__optionsPageLink")) === null ||
        _d === void 0
          ? void 0
          : _d.setAttribute("href", optionsPage);

        (_e = elementById("readergpt__copyButton")) === null || _e === void 0
          ? void 0
          : _e.addEventListener("click", async () => {
              var _a;
              navigator.clipboard.writeText(
                (_a = elementById("readergpt__readableText")) === null ||
                  _a === void 0
                  ? void 0
                  : _a.innerText
              );
        ...
        (_f = elementById("readergpt__crossBtnImg")) === null || _f === void 0
          ? void 0
        ...
        jquery__WEBPACK_IMPORTED_MODULE_1___default()(
          elementById("readergpt__promptSelect")
        ...
        if (navigator && navigator.brave && navigator.brave.isBrave) {
          navigator.brave.isBrave().then((isBrave) => {
            var _a;
            if (isBrave) {
              (_a = elementById("readergpt__braveWarning")) === null ||
              _a === void 0
                ? void 0
    ...
    async function createBridge(content, prompt) {
      showSummaryBlock();
      showSpinner();
      const port = chrome.runtime.connect();
      listenToPortMessages(port);
      port.postMessage({ pageContent: content, promptString: prompt });
    }
    function listenToPortMessages(port) {
      port.onMessage.addListener(async (response) => {
        if (response.event === "DONE") {
          console.log("Completed the summary");
          hideSpinner();
          showHeaderWithOptions();
          showFooter();
        ...
        if (!!response.error) {
          ...
          try {
            ...
            const code =
              errorAnswer === null || errorAnswer === void 0
                ? void 0
                : errorAnswer.code;
            const message =
              errorAnswer === null || errorAnswer === void 0
            ...
            if (code === "message_length_exceeds_limit") {
              ...
              showWarningText(
                "Article is too long and is not supported by ChatGPT yet. Stay tuned for a workaround."
              );
              return;
            }
            if (!!message) {
    ...
    async function showHeaderWithOptions() {
      const promptOptions = await chrome.runtime.sendMessage({
        type: "PROMPT_OPTIONS",
      });
      jquery__WEBPACK_IMPORTED_MODULE_1___default()(
        elementById("readergpt__summaryTextHeader")
      ).removeClass("d-none");
      jquery__WEBPACK_IMPORTED_MODULE_1___default()(
        elementById("readergpt__promptSelect")
      ).empty();
      promptOptions.prompts.forEach((prompt) => {
        var _a;
        const optionEl = document.createElement("option");
        optionEl.innerText = prompt.promptString;
        optionEl.selected = prompt.isDefault;
        (_a = elementById("readergpt__promptSelect")) === null || _a === void 0
          ? void 0
          : _a.append(optionEl);
      });
    }
    async function showFooter() {
      var _a;
      (_a = elementById("readergpt__buyMeACoffee")) === null || _a === void 0
        ? void 0
        : _a.classList.remove("d-none");
    }
    fetchPromptAndTriggerSummary();
    ...
    function showLoginBlock() {
      var _a;
      (_a = elementById("readergpt__loginContainer")) === null || _a === void 0
        ? void 0
        : _a.classList.remove("d-none");
    }
    function showSummaryBlock() {
      ...
      (_b = elementById("readergpt__summaryTextHeader")) === null ||
      _b === void 0
        ? void 0
        : _b.classList.add("d-none");
      (_c = elementById("readergpt__buyMeACoffee")) === null || _c === void 0
        ? void 0
        : _c.classList.add("d-none");
    }
    function showSummaryText(text) {
      var _a, _b, _c;
      (_a = elementById("readergpt__contentContainer")) === null ||
      _a === void 0
        ? void 0
        : _a.classList.remove("d-none");
      (_b = elementById("readergpt__readableText")) === null || _b === void 0
        ? void 0
        : _b.classList.add("alert-secondary");
      (_c = elementById("readergpt__readableText")) === null || _c === void 0
        ? void 0
        : _c.classList.remove("alert-warning");
    ...
    function showWarningText(text) {
      ...
      (_b = elementById("readergpt__readableText")) === null || _b === void 0
        ? void 0
        : _b.classList.remove("alert-secondary");
      (_c = elementById("readergpt__readableText")) === null || _c === void 0
        ? void 0
        : _c.classList.add("alert-warning");
      elementById("readergpt__readableText").innerText = text;
    }
    function showSpinner() {
      var _a, _b, _c, _d;
      (_a = elementById("readergpt__gifContainer")) === null || _a === void 0
        ? void 0
        : _a.classList.remove("d-none");
      (_b = elementById("readergpt__gifContainer")) === null || _b === void 0
        ? void 0
        : _b.classList.add("loading");
      (_c = elementById("readergpt__loginContainer")) === null || _c === void 0
        ? void 0
        : _c.classList.add("loading");
      (_d = elementById("readergpt__contentContainer")) === null ||
      _d === void 0
        ? void 0
        : _d.classList.add("d-none");
    }
    function hideSpinner() {
      ...
      (_b = elementById("readergpt__gifContainer")) === null || _b === void 0
        ? void 0
        : _b.classList.remove("loading");
      (_c = elementById("readergpt__loginContainer")) === null || _c === void 0
        ? void 0
        : _c.classList.remove("loading");
    }
    function elementById(id) {
      var _a, _b;
      return (_b =
        (_a = document.getElementById("readergpt__shadowRoot")) === null ||
        _a === void 0
          ? void 0
          : _a.shadowRoot) === null || _b === void 0
        ? void 0
        : _b.getElementById(id);
    }
  })();
